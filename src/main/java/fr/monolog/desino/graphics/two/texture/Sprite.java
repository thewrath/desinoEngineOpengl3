...
public class Sprite extends Drawable {
	...
	public Sprite(Vector2f position, Vector2f size, TextureRegion textureRegion) {
		super(position, size, "./shaders/vertexSpriteShader.vs", "./shaders/fragmentSpriteShader.fs");
